...
const Chat = () => {
    ...
    const [avatarSelection, setAvatarSelection] = useState(() => {
        const saved = localStorage.getItem('nyra_avatar_selection') || 'digital';
        return saved === 'cute' ? 'digital' : saved;
    });
            ...
            {!immersionMode && (
                <header style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        <img src={logo} alt="NYRA Logo" style={{ height: '32px', width: 'auto', objectFit: 'contain' }} />
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <main style={{ flex: 1, overflowY: 'auto', padding: '20px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                        ...
                        <div style={{ marginTop: 'auto', padding: '20px 0', textAlign: 'center', opacity: 0.3, fontSize: '0.75rem' }}>
                            Built by <a href="https://mdarsalan.vercel.app/" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'underline' }}>Md Arsalan</a>
                        </div>
